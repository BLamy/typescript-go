...
var Argument_exposes_executable_code_that_may_throw_0_after_the_call_returns_A_synchronous_try_catch_or_enclosing_throws_clause_cannot_handle_it_Handle_the_effect_inside_the_capability_or_use_a_non_escaping_contract = &Message{code: 100027, category: CategoryError, key: "Argument_exposes_executable_code_that_may_throw_0_after_the_call_returns_A_synchronous_try_catch_or_encl_100027", text: "Argument exposes executable code that may throw '{0}' after the call returns. A synchronous try/catch or enclosing throws clause cannot handle it; handle the effect inside the capability or use a non-escaping contract."}

var Property_0_s_1_effect_may_throw_2_but_the_target_only_permits_3 = &Message{code: 100028, category: CategoryError, key: "Property_0_s_1_effect_may_throw_2_but_the_target_only_permits_3_100028", text: "Property '{0}'s {1} effect may throw '{2}', but the target only permits '{3}'."}

var Proxy_values_have_latent_property_and_private_brand_effects_that_are_not_representable_by_checked_exceptions_Proxy_construction_and_revocation_are_not_supported_when_checkedExceptions_is_enabled = &Message{code: 100029, category: CategoryError, key: "Proxy_values_have_latent_property_and_private_brand_effects_that_are_not_representable_by_checked_100029", text: "Proxy values have latent property and private-brand effects that are not representable by checked exceptions. Proxy construction and revocation are not supported when 'checkedExceptions' is enabled."}

var An_assertion_from_0_to_the_unresolved_type_1_can_manufacture_checked_effect_guarantees_after_instantiation = &Message{code: 100030, category: CategoryError, key: "An_assertion_from_0_to_the_unresolved_type_1_can_manufacture_checked_effect_guarantees_after_in_100030", text: "An assertion from '{0}' to the unresolved type '{1}' can manufacture checked-effect guarantees after instantiation."}

var Mutating_a_property_through_an_any_or_unknown_alias_can_corrupt_a_checked_effect_contract = &Message{code: 100031, category: CategoryError, key: "Mutating_a_property_through_an_any_or_unknown_alias_can_corrupt_a_checked_effect_contract_100031", text: "Mutating a property through an 'any' or 'unknown' alias can corrupt a checked-effect contract."}
