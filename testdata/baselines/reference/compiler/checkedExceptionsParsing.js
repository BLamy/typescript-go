...
// The clause type may be any type expression, greedily parsed.
function unionClause() { }
function aliasClause() { }
function genericClause(x) {
    throw x;
}
const b = legacy.throws;
class LegacyClass {
    m() { }
    throws = 1;
}
...
//// [checkedExceptionsParsing.d.ts]
declare class E1 extends Error {
    readonly tag: "e1";
}
declare class E2 extends Error {
    readonly tag: "e2";
}
declare function decl(): void throws E1;
...
declare function noReturnType(): void throws E1;
declare function unionClause(): void throws E1 | E2;
type Alias = E1 | E2;
declare function aliasClause(): void throws Alias;
declare function genericClause<T extends Error>(x: T): void throws T;
interface Legacy {
    m(): void;
    throws: boolean;
}
...
declare class LegacyClass {
    m(): void;
    throws: number;
}
declare const throwsAsName: {
    throws: boolean;
};
declare function throws(): void;
