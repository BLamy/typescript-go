...
export const childProperties: Readonly<Partial<Record<SyntaxKind, readonly (string | undefined)[]>>> = {
    ...
    [SyntaxKind.FunctionDeclaration]: ["modifiers", "asteriskToken", "name", "typeParameters", "parameters", "type", "throwsType", "body"],
    ...
    [SyntaxKind.ConstructSignature]: ["typeParameters", "parameters", "type", "throwsType"],
    [SyntaxKind.Constructor]: ["modifiers", "typeParameters", "parameters", "type", "throwsType", "body"],
    [SyntaxKind.GetAccessor]: ["modifiers", "name", "typeParameters", "parameters", "type", "throwsType", "body"],
    [SyntaxKind.SetAccessor]: ["modifiers", "name", "typeParameters", "parameters", "type", "throwsType", "body"],
    [SyntaxKind.IndexSignature]: ["modifiers", "parameters", "type"],
    [SyntaxKind.MethodSignature]: ["modifiers", "name", "postfixToken", "typeParameters", "parameters", "type", "throwsType"],
    [SyntaxKind.MethodDeclaration]: ["modifiers", "asteriskToken", "name", "postfixToken", "typeParameters", "parameters", "type", "throwsType", "body"],
    ...
    [SyntaxKind.ArrowFunction]: ["modifiers", "typeParameters", "parameters", "type", "throwsType", "equalsGreaterThanToken", "body"],
    [SyntaxKind.FunctionExpression]: ["modifiers", "asteriskToken", "name", "typeParameters", "parameters", "type", "throwsType", "body"],
    ...
    [SyntaxKind.FunctionType]: ["typeParameters", "parameters", "type", "throwsType"],
    [SyntaxKind.ConstructorType]: ["modifiers", "typeParameters", "parameters", "type", "throwsType"],
